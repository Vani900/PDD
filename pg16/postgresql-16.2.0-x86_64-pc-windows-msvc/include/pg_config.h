...
#define CONFIGURE_ARGS " '--prefix' '/d/a/postgresql-binaries/postgresql-binaries/postgresql-16.2.0-x86_64-pc-windows-msvc' '--with-readline' '--with-template=win32' '--without-icu' 'PKG_CONFIG_PATH=C:\hostedtoolcache\windows\Python\3.12.1\x64/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on x86_64-pc-mingw64, compiled by gcc.exe (x86_64-posix-seh, Built by strawberryperl.com project) 8.3.0, 64-bit"
