...
data class LoginResponse(val access_token: String, val refresh_token: String, val user_id: String)
data class RegisterRequest(val first_name: String, val last_name: String, val email: String, val password: String, val role: String = "donor")
data class UserProfileDto(val user_id: String, val email: String, val first_name: String, val last_name: String, val role: String, val completion_percentage: Int)

data class DonationDto(val id: String, val title: String, val donation_type: String, val status: String, val tracking_number: String, val amount: Double?)
...
interface CharityAIApiService {
    ...
    suspend fun getDonations(@Header("Authorization") token: String, @Query("page") page: Int = 1): Response<ListDonationsResponse>

    @POST("api/v1/donations")
    suspend fun createDonation(@Header("Authorization") token: String, @Body payload: Map<String, Any>): Response<Map<String, Any>>

    @PUT("api/v1/donations/{id}/status")
    suspend fun updateDonationStatus(@Header("Authorization") token: String, @Path("id") id: String, @Body payload: Map<String, Any>): Response<Map<String, Any>>
